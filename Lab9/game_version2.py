...
while True:
    ...
    #Displaying speed of enemy
    spped_of_enemy = font_small.render(str(SPEED), True, BLACK)
    DISPLAYSURF.blit(spped_of_enemy, (100,10))
    ...
    if COINS >= last_speed_increase + COINS_TO_SPEED_UP:
        SPEED += 0.5 
        last_speed_increase = COINS
